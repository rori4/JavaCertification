...
public class A55_Question {
    ...
    Unlike in a regular for loop, there is no iteration variable available in an enhanced for loop, so it is not possible to determine the number of the iteration just by using the enhanced for loop. You will need to do something like:  int i = 0; for(Object obj : collectionOrArray){   System.out.println("Iteration number = "+i+" Object = "+obj);   i++; }
