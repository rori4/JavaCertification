...
Although primitives are not Objects since 1.4 java autoboxes the primitives into their object pendants and this is why we can add them to Object[]. If you try to get the class of objArr[2] you will get class java.lang.Boolean.
'this' references the current class which is also an object so we can add it
*/
